...
def main():
    ### INPUT #####################################################################################################
    # Model parameters
    data_yaml = os.path.abspath(os.path.join(os.path.dirname(os.path.abspath(__file__)), 'cdnet_BSHBD_80-10-10-page_200', 'data.yaml'))
    project=os.path.abspath(os.path.join(os.path.dirname(os.path.abspath(__file__)), 'cdnet_BSHBD_80-10-10-page_200','yolov9e'))
    name='20240502_T1720'
    ...
    # Yaml path 
    dataset_path = os.path.abspath(os.path.join(os.path.dirname(os.path.abspath(__file__)), '..', 'data', 'BSHBD_80-10-10-page_200'))
