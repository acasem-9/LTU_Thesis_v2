...
SEPARATED_D_DATA_DIR = os.path.abspath(os.path.join(os.path.dirname(os.path.abspath(__file__)), 'data/raw/separated_d_data'))
SEPARATED_C_DATA_DIR_SAMPLE = os.path.abspath(os.path.join(os.path.dirname(os.path.abspath(__file__)), 'data/raw/separated_c_data_sampled'))
SEPARATED_D_DATA_DIR_SAMPLE = os.path.abspath(os.path.join(os.path.dirname(os.path.abspath(__file__)), 'data/raw/separated_d_data_sampled'))
...
################################################################################################################################################################
# Relative paths from the _ directory ##########################################################################################################################
