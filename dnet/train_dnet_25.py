...
def main():
    ### INPUT #####################################################################################################
    # Model parameters
    data_yaml = os.path.abspath(os.path.join(os.path.dirname(os.path.abspath(__file__)), 'dnet_dataset_80-10-10-page_25', 'd_data.yaml'))
    project=os.path.abspath(os.path.join(os.path.dirname(os.path.abspath(__file__)), 'dnet_dataset_80-10-10-page_25','yolov8x'))#'./yolov8m'
    ...
    # Yaml path 
    dataset_path = os.path.abspath(os.path.join(os.path.dirname(os.path.abspath(__file__)), '..', 'data', 'dataset_80-10-10-page_25/d_data'))
