...
# Naming of job:
#SBATCH -J cdnet_full-BSHBD-32_train

# Job output:
#SBATCH -o cdnet_full-BSHBD-32_train_%j.out
#SBATCH -e cdnet_full-BSHBD-32_train_%j.err
...
# Run the work tasks:
echo "Start work"
python train_cdnet_BSHBD_80-10-10_full_32.py
