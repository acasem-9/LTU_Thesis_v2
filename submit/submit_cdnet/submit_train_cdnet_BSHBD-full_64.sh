...
# Naming of job:
#SBATCH -J cdnet_full-BSHBD-64_train

# Job output:
#SBATCH -o cdnet_full-BSHBD-64_train_%j.out
#SBATCH -e cdnet_full-BSHBD-64_train_%j.err
...
# Run the work tasks:
echo "Start work"
python train_cdnet_BSHBD_80-10-10_full_64.py
